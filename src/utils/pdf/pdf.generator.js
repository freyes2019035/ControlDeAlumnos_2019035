...
const generateBody = (data) => {
       ...
       <tbody>
         <tr>
           <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;" align="left">
             <div>
               <h1 class="text-center" style="margin-top: 0; margin-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 36px; line-height: 43.2px;" align="center">Course Report</h1>
     ...
     <table class="table table-striped" border="0" cellpadding="0" cellspacing="0" style="font-family: Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: collapse; width: 100%; max-width: 100%;">
       <thead>
         <tr>
           <th scope="col" style="line-height: 24px; font-size: 16px; border-bottom-width: 2px; border-bottom-color: #dee2e6; border-bottom-style: solid; border-top-width: 1px; border-top-color: #dee2e6; border-top-style: solid; margin: 0; padding: 12px;" align="left" valign="top">ID</th>
           <th scope="col" style="line-height: 24px; font-size: 16px; border-bottom-width: 2px; border-bottom-color: #dee2e6; border-bottom-style: solid; border-top-width: 1px; border-top-color: #dee2e6; border-top-style: solid; margin: 0; padding: 12px;" align="left" valign="top">Curso</th>
         </tr>
       </thead>
       <tbody>
    `
    for (let i = 0; i < data.cursos.length; i++) {
        ...
        <th style="line-height: 24px; font-size: 16px; margin: 0;" align="left">${data.cursos[i]._id}</th>
        <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-top-width: 1px; border-top-color: #dee2e6; border-top-style: solid; margin: 0; padding: 12px;" align="left" valign="top">${data.cursos[i].nombre}</td>
        </tr>
        `
    }
    content += `
...
exports.generatePDF = async (data) => {
    ...
    generateBody(data);
    return pdf.createAsync(content, { filename: `./alumno_data/pdf/CoursesReport_${data.nombre}__${today}.pdf` })
}
